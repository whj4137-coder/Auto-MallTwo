...
**更新时间**：2026-06-02 ｜ **会话**：S-037 ｜ **active changes**：0001–0011 全 **Accepted**；SPEC-001..005 **APPROVED**（已冻结）
...
- **工程门禁就位**：`npm run verify`（typecheck + check:ssot + L1/L2）+ commit-gate hook；L3 Playwright 单独 `npm run test:e2e`；LAYOUT-01 已固化为 1280×720 布局审计。
