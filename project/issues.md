...
| I-009 | SPEC | P1 | OPEN | 五份 SPEC（001..005）当前为 DRAFT，待 PRD 评审冻结后转 APPROVED 并锁定（PRD §16 OQ-005） | S-006 | - | SPEC-001..005 |
...
| I-013 | SPEC | P2 | OPEN | PRD §16 开放问题 OQ-001（Admin v1 范围）/OQ-004（高保真原型形态）/OQ-005（冻结日期）待评审确认 | S-016 | - | - |
| I-014 | W | P1 | OPEN | 高保真 P1 首页（深色座舱 v7）信息密度高于 §10.8 锁定（精选3+服务3）：改为 Bento+类目条+精选横滑rail+分类货架(展示全部商品)。已建 openspec change 0001 待评审冻结，未静默改 PRD | S-017 | - | REQ-001 |
