...
| 3 | **Web 前端**（前台 P1–P13） | — | ✅ 核心闭环完成（搜索独立页待补） |
| 4 | 后端 Express + Admin（三端联动） | — | ✅ 核心 + Admin 完整 CRUD 完成 |
| 5 | 验收与演示就绪 | TBD | 🟡 进行中（自动化测试 L1/L2/L3 已落地；演示脚本/全量用例待补） |
...
| 0001 | 首页改版（vs §10.8） | 🟡 Draft 待评审 | Phase 3 |
| 0009 | 自动化测试 L1/L2/L3 | ✅ Accepted | Phase 5 |
| 0010 | Admin 完整 CRUD（新增·编辑） | ✅ Accepted | Phase 4 |

**下一步优先级**：①评审冻结 0001/0006/0007/0010 与 PRD §10.8/§12/§15.14/SPEC-004 → ②扩 E2E（A-02/C-01/D-02/SEARCH-01 + Admin 改→前台实时生效）→ ③演示脚本 + Phase 5 DoD 收尾。
...
- [ ] 评审冻结：PRD §10/§11 进入「改动须走 openspec」状态（待用户确认）
